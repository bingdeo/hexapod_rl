...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src='Picture/hardware architecture.png' width='50%'/>
  </div>
</div>
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src='Picture/cal1.png' width='40%'/>
    <img src='Picture/cal2.png' width='40%'/>
  </div>
</div>
<br>
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src='Picture/final model.png' width='50%'/>
  </div>
</div>
